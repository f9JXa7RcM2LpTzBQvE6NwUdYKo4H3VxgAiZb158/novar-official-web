...
import Leaderboards from './modules/Leaderboards.js?v=nav42';
import Partners from './modules/Partners.js?v=nav43';
...
class App {
  ...
  initRoutes() {
    ...
    const sections = ['download', 'purpose', 'features', 'sponsor', 'contact'];
